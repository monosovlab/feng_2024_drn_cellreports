...
%       Sided-  (String) can be 'one', 'left', 'right', 'two' (the default), or 'two, equal 
...
%               than the observed number of successes. 'left' or 'right' forces to be lesser or greater, respectively. 'Two' will use the
