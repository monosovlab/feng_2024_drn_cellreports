...
%     orders of magnitude! However, it errs on the side of being 
%     conservative, and it seems quite accurate for p >= 0.05, which is the
%     key region for most of our use cases.
%     (this is the default)
