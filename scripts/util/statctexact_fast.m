function [pval,pvals]=statctexact_fast(x,wts,tstar,dispopt)
...
% 
% ESBM: found on 2019-03-17 as statctexact2 on this website:
%    https://senselab.med.yale.edu/modeldb/ShowModel.cshtml?model=144007&file=%2FLGMD%2Fjneurosci2012%2Fsupport%2Fstatfuncs%2Fprivate%2Fstatctexact2.m#tabs-2
%  renamed to "statctexact_fast" for use with my own 'fast' versions of 
%  certain stats functions. Despite the name with _fast in it, isn't 
%  actually changed at all from the version I found online. It's probably 
%  possible to speed this up, too, but I haven't tried yet.
